    ...
    <div class="create-book container">
        ...
        <form class="register-form" action="{{route('storeBook')}}" method="post">
            ...
            <div class="mb-4">
                ...
                <br>
                <input value="{{ old('release') }}" type="date" name="released_at"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" cols="30" rows="6"
                    class="form-control @error('description') is-invalid @enderror" placeholder="Enter a brief description of the book">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
